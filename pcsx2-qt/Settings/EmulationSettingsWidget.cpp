	...
	: SettingsWidget(settings_dialog, parent)
{
	...
	dialog()->registerWidgetHelp(m_ui.vsync, tr("Vertical Sync (VSync)"), tr("Unchecked"),
		tr("Enable this option to match PenguinScreen2's refresh rate with your current monitor or screen. VSync is automatically disabled when "
	...
	dialog()->registerWidgetHelp(m_ui.useVSyncForTiming, tr("Use Host VSync Timing"), tr("Unchecked"),
		tr("When synchronizing with the host refresh rate, this option disables PenguinScreen2's internal frame timing and uses the host instead. "
