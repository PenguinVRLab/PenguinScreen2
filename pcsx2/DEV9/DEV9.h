...
#define SPD_INTR_ATA_FIFO_FULL		(1 << 15)
#define SPD_INTR_ATA_FIFO_EMPTY		(1 << 14)
#define SPD_INTR_ATA_FIFO_OVERFLOW	(SPD_INTR_ATA_FIFO_FULL | SPD_INTR_ATA_FIFO_EMPTY)
...
#define		SPD_DBUF_STAT_1		(1 << 5)
#define		SPD_DBUF_STAT_2		(1 << 6)
...
#define		SPD_IF_ATA_DMAEN	(1 << 2)
#define		SPD_IF_HDD_RESET	(1 << 6)
#define		SPD_IF_ATA_RESET	(1 << 7)
...
#define	  SMAP_E3_TX_GNP_0			(1<<(15+16))
#define	  SMAP_E3_TX_GNP_1			(1<<(14+16))
#define	  SMAP_E3_TX_GNP_DEPEND		(1<<(13+16))
...
#define ATA_R_FEATURE		(ATA_DEV9_HDD_BASE + 0x02)
...
#define ATA_R_CMD			(ATA_DEV9_HDD_BASE + 0x0e)
#define ATA_R_ALT_STATUS	(ATA_DEV9_HDD_BASE + 0x1c)
#define ATA_R_CONTROL		(ATA_DEV9_HDD_BASE + 0x1c)
#define ATA_DEV9_INT		(0x01)
#define ATA_DEV9_INT_DMA	(0x02)
...
#define FLASH_PP_READY (1 << 0)
#define FLASH_PP_WRITE (1 << 7)
#define FLASH_PP_CSEL (1 << 8)
#define FLASH_PP_READ (1 << 11)
#define FLASH_PP_NOECC (1 << 12)
