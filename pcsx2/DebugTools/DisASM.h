...
#define DECODE_RD     ((disasmOpcode >> 11) & 0x1F)
#define DECODE_RT     ((disasmOpcode >> 16) & 0x1F)
#define DECODE_RS     ((disasmOpcode >> 21) & 0x1F)
#define DECODE_SA     ((disasmOpcode >>  6) & 0x1F)
#define DECODE_IMMED     ( disasmOpcode & 0xFFFF)
